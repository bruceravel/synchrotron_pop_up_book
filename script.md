...
The monochromator filters the light generated by the source (bend magnet, undulator, etc.), selecting
just the energy required by the experiment.  For experiments requiring high-energy X-rays,
energy selection is typically made using very pure silicon crystals, although other materials may also be used, while for lower energy X-rays, a grating may be used instead of a crystal.

Both crystals and gratings work like a prism, separating a "white" beam of X-rays in to X-rays of different energies (like colors for visible light). By choosing the orientation of the crystal or grating, a specific energy of X-ray can be made to hit the second crystal. The second crystal redirects the X-rays of the chosen energy towards the
end station. The orientation of the crystal or grating is computer-controlled, allowing different energies to be chosen during an experiment.
