...
This small room contains the instruments used to process the X-rays
generated by the (WW storage ring) so that they can be used for a
particular experiment at a (WW beamline).  Each kind of experiment has
special requirements.  The **FOE** shown here is typical, although the
various kinds of experiments result in a variety of designs.
...
That small spot is where the X-ray beam hits the sample!
...
The **monochromator** filters the light generated by the bend magnet
